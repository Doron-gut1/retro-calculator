...
namespace RetroCalculator.Api.Services
{
    public class PropertyService : IPropertyService
    {
        ...
        public async Task<PropertyResponse> GetProperty(string propertyId)
        {
            ...
            var command = new SqlCommand("GetPropertyDetails", connection);
            ...
            if (await reader.ReadAsync())
            {
                return new PropertyResponse
                {
                    ...
                    Tariff1Name = reader["mas1_name"]?.ToString(),
                    ...
                    Tariff2Name = reader["mas2_name"]?.ToString(),
                    ...
                    Tariff3Name = reader["mas3_name"]?.ToString(),
                    ...
                    Tariff4Name = reader["mas4_name"]?.ToString(),
                    ...
                    Tariff5Name = reader["mas5_name"]?.ToString(),
                    ...
                    Tariff6Name = reader["mas6_name"]?.ToString(),
                    ...
                    Tariff7Name = reader["mas7_name"]?.ToString(),
                    ...
                    Tariff8Name = reader["mas8_name"]?.ToString(),
