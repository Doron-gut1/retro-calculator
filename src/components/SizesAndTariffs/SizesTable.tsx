...
export const SizesTable: React.FC<SizesTableProps> = ({ property, onDeleteSize, onAddSize }) => {
  const sizes = [
    { index: 1, size: property.godel, code: property.mas, name: property.masName },
    { index: 2, size: property.gdl2, code: property.mas2, name: property.mas2Name },
    { index: 3, size: property.gdl3, code: property.mas3, name: property.mas3Name },
    { index: 4, size: property.gdl4, code: property.mas4, name: property.mas4Name },
    { index: 5, size: property.gdl5, code: property.mas5, name: property.mas5Name },
    { index: 6, size: property.gdl6, code: property.mas6, name: property.mas6Name },
    { index: 7, size: property.gdl7, code: property.mas7, name: property.mas7Name },
    { index: 8, size: property.gdl8, code: property.mas8, name: property.mas8Name },
  ].filter(row => row.size > 0);

  const totalSize = sizes.reduce((sum, row) => sum + (row.size || 0), 0);
